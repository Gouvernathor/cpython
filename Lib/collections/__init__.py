...
def namedtuple(typename, field_names, *, rename=False, defaults=None, module=None) -> NamedTupleMeta:
    ...
    return NamedTupleMeta(typename, (), namespace, rename=rename, module=module)
